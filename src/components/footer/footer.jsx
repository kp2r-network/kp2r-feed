    ...
    return (
      ...
      <div className={ classes.products }>
        ...
        <div  className={ classes.link } >
          ...
          <img alt="CMC" src={ require('../../assets/partner/cmc.png') } height='36px' onClick={()=> window.open("/", "_blank")} className={ classes.icon } />
      ...
      <div  className={ classes.link } onClick={()=> window.open("https://omgswap.in/", "_blank")} >© 2020 Copyright - KP2R Network is A Concern of Omega Protocol Ltd.
      </div>
      </div>
      </div>
    )
